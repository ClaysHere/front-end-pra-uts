...
const teks = [
  ...
  [
    ...
    '<h2 class=\'title\'>Taxonomy</h2></br><p>The word "dugong" derives from the Visayan (probably Cebuano) dugung. The name was first adopted and popularized by the French naturalist Georges-Louis Leclerc, Comte de Buffon, as "dugon" in Histoire Naturelle (1765), after descriptions of the hewan from the island of Leyte in the Philippines. The name ultimately derives from Proto-Malayo-Polynesian *duyuŋ. Despite common misconception, the term does not come from Malay duyung and it does not mean "lady of the sea" (Mermaid).</br></br>\
...
const tab1 = document.querySelector("#blue-whale-nav");
const tab2 = document.querySelector("#great-white-shark-nav");
const tab3 = document.querySelector("#red-panda-nav");
const tab4 = document.querySelector("#dugong-nav");
const tab5 = document.querySelector("#sumatran-rhinoceros-nav");
